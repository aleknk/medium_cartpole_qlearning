...
class QLearningAgent:
    def __init__(self, env, learning_rate=0.1, discount_factor=0.99,
                 start_exploration_prob=1.0, final_exploration_prob=0.01, exploration_decay=1e4,
                 max_values=[2.4, 3.0, 0.3, 3.0], min_values=[-2.4, -3.0, -0.3, -3.0], num_bins=[20, 20, 20, 20]):
        """
    ...
    def play(self, n_episodes=10, save_gif_path=None):
        """
    ...
    def make_gif(self, frames, save_path, duration=1/40):
        """
