...
def main():
    ...
    parser.add_argument("--agent_dir", type=str, default="./results/learn_run_1", help="Path to agent.")
    parser.add_argument("--n_episodes", type=int, default=10, help="Number of episodes for playing.")
